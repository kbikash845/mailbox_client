...
function MailBox() {
  ...
  const sendEmailHandler = (event) => {
    ...
    fetch(`https://clone-21efb-default-rtdb.firebaseio.com/user/${changedemail}.json`, {
        method: 'POST',
      ...
      fetch(`https://clone-21efb-default-rtdb.firebaseio.com/sent/user/${changedEnteredEmail}.json`, {
        method: 'POST',
  ...
  return (
    ...
    <section className=" bg-gradient-to-b from-gray-500 p-8 shadow-lg rounded-3" style={{marginLeft:"17%",marginRight:"12%",position:"relative", marginTop: "70px"}}>
